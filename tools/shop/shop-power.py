#!/usr/bin/env python3
"""Add the power line (3 pole parts, 4 wire spools) and the full-block
one-way bridge to the survival shop.
...
anything is changed. No new categories this time - a pole and its wire are
network hardware, and `industrial` is where the gauges and the switches
already live.
...
# ---- the wave -------------------------------------------------------------
#
# The pole parts are priced as what they are: the mast is the cheap thing you
# buy a stack of to gain height, the head is the fitting that does the work.
# A spool follows its tier the way the gauges follow their complexity, and the
# ladder is steep on purpose - the top tier reaches three times as far and
# carries two hundred times the power of the bottom one.

ITEMS = [
	# the one-way bridge's full-block form, priced a step over the fitting the
	# way every gauge's dashboard form is priced over its panel
	('gauge', 'industrial', 18.0, 'network_diode_block'),
	('pole', 'industrial', 6.0, 'power_pole_base'),
	('pole', 'industrial', 4.0, 'power_pole'),
	('pole', 'industrial', 12.0, 'power_pole_head'),
	('wire', 'industrial', 4.0, 'power_wire_basic'),
	('wire', 'industrial', 10.0, 'power_wire_advanced'),
	('wire', 'industrial', 25.0, 'power_wire_elite'),
	('wire', 'industrial', 60.0, 'power_wire_ultimate'),
]
