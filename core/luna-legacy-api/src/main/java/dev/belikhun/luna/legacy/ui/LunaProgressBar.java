...
public final class LunaProgressBar {
	...
	private static final TextRenderer DEFAULT_TEXT_RENDERER = context -> {
		if (context == null || context.text() == null || Strings.isBlank(context.text())) {
			return "";
		}
	...
	public static final class BarRenderContext {
		private final double percent;
		private final int width;
		private final String glyph;
		private final String filledColor;
		private final String emptyColor;
		private final boolean filledGradientEnabled;
		private final String[] filledGradientColors;

		public BarRenderContext(double percent, int width, String glyph, String filledColor, String emptyColor, boolean filledGradientEnabled, String[] filledGradientColors) {
			this.percent = percent;
			this.width = width;
			this.glyph = glyph;
			this.filledColor = filledColor;
			this.emptyColor = emptyColor;
			this.filledGradientEnabled = filledGradientEnabled;
			this.filledGradientColors = filledGradientColors;
		}
		...
		public boolean filledGradientEnabled() {
			return filledGradientEnabled;
		}

		public String[] filledGradientColors() {
			return filledGradientColors;
		}

		}

	public static final class TextRenderContext {
		private final String text;
		private final String color;

		public TextRenderContext(String text, String color) {
			this.text = text;
			this.color = color;
		}
	...
	public LunaProgressBar glyph(String value) {
		this.glyph = Strings.isBlank(value) ? DEFAULT_GLYPH : value;
		return this;
	}
	...
	public String render() {
		...
		switch (layout) {
			case ALL_LEFT:
				appendParts(out, renderedLabel, renderedValue, renderedBar);
				break;

			case ALL_RIGHT:
				appendParts(out, renderedBar, renderedLabel, renderedValue);
				break;

			default:
				appendParts(out, renderedLabel, renderedBar, renderedValue);
				break;
		}
