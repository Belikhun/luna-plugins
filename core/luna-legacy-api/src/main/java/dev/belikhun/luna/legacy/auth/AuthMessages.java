...
public final class AuthMessages {
	...
	public static final List<Integer> MODE_SELECTOR_FRAME_SLOTS =
		Collections.unmodifiableList(Arrays.asList(0, 1, 2, 6, 8));
	...
	public static final class PromptText {
		...
		public PromptText(String bossbar, String actionbar, String chat) {
	...
	public static List<String> frameItemLore() {
		return Collections.singletonList("<gray> </gray>");
	}
