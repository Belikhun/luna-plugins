 ...
 */
public interface PlaceholderService<P> {
	 ...
	 */
	Map<String, String> snapshot(P player, Collection<String> requestedIdentifiers);
	 ...
	 */
	String resolvePlaceholder(P player, String identifier);
}
