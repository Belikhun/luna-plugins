...
public final class AmqpPluginMessageEnvelope {
	...
	public AmqpPluginMessageEnvelope(int protocolVersion, String channel, String sourceServerName, String sourcePlayerId, String sourcePlayerName, String targetServerName, byte[] payload) {
