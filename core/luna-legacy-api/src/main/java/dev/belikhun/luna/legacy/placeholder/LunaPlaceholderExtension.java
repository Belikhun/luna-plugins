 ...
 */
public interface LunaPlaceholderExtension<P> {
	 ...
	 */
	String resolve(P player, String namespace, String params);
	 ...
	 */
	default void contributeSnapshot(P player, Map<String, String> values) {
	}
}
