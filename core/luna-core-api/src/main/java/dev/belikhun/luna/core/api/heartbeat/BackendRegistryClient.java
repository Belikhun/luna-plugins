...
public final class BackendRegistryClient {
	...
	/**
	 * A consumer wired after the first fetch would otherwise never see a body:
	 * the checksum already matches what the proxy is serving and every later
	 * fetch returns early. Clearing it makes the next sync deliver.
	 *
