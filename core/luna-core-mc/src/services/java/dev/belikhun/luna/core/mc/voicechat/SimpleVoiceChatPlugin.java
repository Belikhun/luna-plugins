package dev.belikhun.luna.core.mc.voicechat;
...
public final class SimpleVoiceChatPlugin implements VoicechatPlugin {
	private static final SimpleVoiceChatProvider PROVIDER = new SimpleVoiceChatProvider();
	private static final LunaLogger LOGGER = LunaLoggers.create("LunaCore", true).scope("VoiceChat");
	...
	public void registerEvents(EventRegistration registration) {
		...
		registration.registerEvent(PlayerStateChangedEvent.class, SimpleVoiceChatPlugin::logStateChange);
