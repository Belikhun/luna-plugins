...
final class ImportedPlaceholderProvider implements ServerPlaceholderProvider {
	@Override
	...
	private String resolveLunaParams(
		...
		Matcher worldWeatherMatcher = BuiltInPlaceholderService.WORLD_WEATHER_PATTERN.matcher(expandedKey);
		...
		Matcher playerStatusMatcher = BuiltInPlaceholderService.PLAYER_STATUS_PATTERN.matcher(expandedKey);
		...
		Matcher playerDimensionMatcher = BuiltInPlaceholderService.PLAYER_DIMENSION_PATTERN.matcher(expandedKey);
		...
		Matcher stripColorMatcher = BuiltInPlaceholderService.STRIP_COLOR_PATTERN.matcher(expandedKey);
		...
		Matcher mm2lMatcher = BuiltInPlaceholderService.MM2L_PATTERN.matcher(expandedKey);
	...
	private String replaceInnerPlaceholders(
		...
		for (int depth = 0; depth < 8; depth++) {
			Matcher matcher = BuiltInPlaceholderService.BRACKET_PATTERN.matcher(resolved);
