...
import dev.belikhun.luna.core.mc.compat.ComponentJson;
import net.minecraft.server.MinecraftServer;
import net.kyori.adventure.text.Component;
import net.kyori.adventure.text.minimessage.MiniMessage;
import net.kyori.adventure.text.serializer.gson.GsonComponentSerializer;

public final class ServerTextComponents {
	private static final Gson GSON = new GsonBuilder().disableHtmlEscaping().create();
	private static final MiniMessage MINI_MESSAGE = MiniMessage.miniMessage();
	private static final GsonComponentSerializer GSON_COMPONENT_SERIALIZER = GsonComponentSerializer.gson();

	private ServerTextComponents() {
	}
	...
	public static net.minecraft.network.chat.Component adventure(MinecraftServer server, Component component) {
		...
		return ComponentJson.parse(server, jsonElement);
	}
}
