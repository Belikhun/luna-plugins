...
final class BuiltinPlaceholderProvider implements ServerPlaceholderProvider {
	@Override
	...
	public void contributeSnapshot(
		...
		support.putCore(values, "color", BuiltInPlaceholderService.DEFAULT_COLOR);
		...
		support.putCore(values, "tps_bar", support.buildBar(LunaProgressBarPresets.tps("tps", snapshot.currentTps()), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "player_ping_bar", support.buildBar(LunaProgressBarPresets.latency("ping", playerPingMillis), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "latency_bar", support.buildBar(LunaProgressBarPresets.latency("latency", 0D), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "system_cpu_bar", support.buildBar(LunaProgressBarPresets.cpu("sys<gray>%</gray>", snapshot.systemCpuPercent()), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "process_cpu_bar", support.buildBar(LunaProgressBarPresets.cpu("proc<gray>%</gray>", snapshot.processCpuPercent()), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "ram_bar", support.buildBar(LunaProgressBarPresets.ram("ram", snapshot.ramUsedBytes(), snapshot.ramMaxBytes()), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));

		support.putCore(values, "tps_bar_only", support.buildBarOnly(LunaProgressBarPresets.tps("tps", snapshot.currentTps()), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "player_ping_bar_only", support.buildBarOnly(LunaProgressBarPresets.latency("ping", playerPingMillis), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "latency_bar_only", support.buildBarOnly(LunaProgressBarPresets.latency("latency", 0D), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "system_cpu_bar_only", support.buildBarOnly(LunaProgressBarPresets.cpu("sys<gray>%</gray>", snapshot.systemCpuPercent()), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "process_cpu_bar_only", support.buildBarOnly(LunaProgressBarPresets.cpu("proc<gray>%</gray>", snapshot.processCpuPercent()), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
		support.putCore(values, "ram_bar_only", support.buildBarOnly(LunaProgressBarPresets.ram("ram", snapshot.ramUsedBytes(), snapshot.ramMaxBytes()), BuiltInPlaceholderService.DEFAULT_BAR_WIDTH));
	...
	private String resolveLunaValue(
		...
		String value = switch (normalizedKey) {
			...
			case "color" -> BuiltInPlaceholderService.DEFAULT_COLOR;
