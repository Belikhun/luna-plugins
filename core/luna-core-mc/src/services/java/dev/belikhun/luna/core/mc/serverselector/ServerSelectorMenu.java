...
final class ServerSelectorMenu extends AbstractContainerMenu {
	static final int ROWS = 6;
	static final int CONTAINER_SIZE = ROWS * 9;
	...
	ServerSelectorMenu(int containerId, Inventory playerInventory, Runnable closeListener) {
	...
	void setTopSlot(int slot, ItemStack stack, Runnable action) {
	...
	void suppressCloseCallbackOnce() {
