...
/** What a heartbeat needs to know about a NeoForge dedicated server. */
public final class NeoForgeServerProbe implements BackendServerProbe {
	private final MinecraftServer server;

	public NeoForgeServerProbe(MinecraftServer server) {
		this.server = server;
	}
