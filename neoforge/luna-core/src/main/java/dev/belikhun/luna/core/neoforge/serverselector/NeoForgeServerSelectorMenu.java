...
final class NeoForgeServerSelectorMenu extends AbstractContainerMenu {
	...
	NeoForgeServerSelectorMenu(int containerId, Inventory playerInventory, Runnable closeListener) {
