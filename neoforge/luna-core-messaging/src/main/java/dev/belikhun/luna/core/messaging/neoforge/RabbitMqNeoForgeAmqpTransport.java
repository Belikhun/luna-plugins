 ...
 */
final class RabbitMqNeoForgeAmqpTransport implements NeoForgeAmqpTransport, AmqpEndpoint {
	...
	RabbitMqNeoForgeAmqpTransport(NeoForgePluginMessagingBus bus, BackendIdentity backendIdentity, LunaLogger logger, boolean loggingEnabled) {
		this.bus = bus;
