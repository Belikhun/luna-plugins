...
public final class NeoForgePluginMessagingBus implements PluginMessageBus<ServerPlayer, ServerPlayer> {
	...
	public NeoForgePluginMessagingBus(LunaLogger logger, BackendIdentity backendIdentity, boolean loggingEnabled) {
	...
	private NeoForgeAmqpTransport createAmqpTransport() {
		try {
			return new RabbitMqNeoForgeAmqpTransport(this, backendIdentity, logger.scope("Amqp/rabbitmq"), loggingEnabled);
