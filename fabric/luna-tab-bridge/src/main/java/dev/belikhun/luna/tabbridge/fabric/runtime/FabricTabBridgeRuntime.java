...
public interface FabricTabBridgeRuntime extends AutoCloseable {
	boolean sendRaw(ServerPlayer player, byte[] payload);

	default void bindPlaceholderResolver(FabricTabBridgePlaceholderResolver placeholderResolver) {
	}
	...
	Optional<FabricTabBridgePacket> latestPacket(UUID playerId);
