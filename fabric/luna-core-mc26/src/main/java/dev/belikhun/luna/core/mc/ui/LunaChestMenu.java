 ...
 * reason this class exists twice; the 1.20-1.21 copy lives in
 * luna-core-fabric/src/mc21. The two enums carry the same constants, so both
 * copies hand the base the constant's name and {@code LunaClick} maps it once.
 */
