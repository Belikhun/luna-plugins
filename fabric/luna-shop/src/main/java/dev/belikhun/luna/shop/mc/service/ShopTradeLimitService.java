...
public final class ShopTradeLimitService {
	...
	public ShopTradeLimitService(MinecraftServer server) {
		this.server = server;
	...
	public long millisUntilReset() {
		...
		long dayTime = Math.floorMod(level.getGameTime(), MINECRAFT_DAY_TICKS);
	...
	private long currentDay() {
		...
		return level.getGameTime() / MINECRAFT_DAY_TICKS;
	}
