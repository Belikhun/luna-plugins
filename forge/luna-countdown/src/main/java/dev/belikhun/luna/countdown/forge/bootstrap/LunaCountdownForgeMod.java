package dev.belikhun.luna.countdown.forge.bootstrap;
...
@Mod(LunaCountdownForgeMod.MOD_ID)
public final class LunaCountdownForgeMod {
	...
	public void onServerStarted(ServerStartedEvent event) {
		if (!LunaCore.isReady()) {
			logger.error("LunaCore chưa sẵn sàng. LunaCountdown Forge sẽ không khởi động.");
			return;
		}
		...
		logger.success("Luna Countdown Forge runtime đã sẵn sàng.");
	}
