package dev.belikhun.luna.core.fabric.adapter.mc1201;
...
public final class Mc1201NetworkingAdapter extends AbstractFabricFamilyNetworkingAdapter {
	...
	public String adapterId() {
		return "fabric-networking-mc1201";
	}

	@Override
	public void initialize() {
		Mc1201Bootstrap.bridge().setOutboundSender(this::sendOutbound);
	...
	private void handleIncomingFromCallback(Object[] callbackArgs) {
		...
		try {
			...
			Runnable task = () -> Mc1201Bootstrap.bridge().injectIncoming(channel, payload);
